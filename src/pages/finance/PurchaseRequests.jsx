        ...
        <div className="hr-toolbar">
          ...
          <div className="hr-toolbar-right">
            ...
            {can('procurement.requisitions.create') && (
              <button className="hr-btn-primary" onClick={() => navigate('/finance/purchase-requests/create')}>
                <Plus size={16} /> New PR
              </button>
            )}
          </div>
            ...
            <div className="note-detail">
              ...
              <div className="hr-form-actions">
                ...
                {can('procurement.requisitions.edit') && (pr.status === 'draft' || pr.status === 'revision' || pr.status === 'rejected') && (
                  <button className="hr-btn-primary" onClick={() => { setViewItem(null); navigate(`/finance/purchase-requests/${pr.id}/edit`) }}><Pencil size={14} /> Edit</button>
                )}
