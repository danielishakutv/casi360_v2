        ...
        <div className="hr-toolbar">
          ...
          <div className="hr-toolbar-right">
            ...
            {can('procurement.requisitions.create') && (
              <button className="hr-btn-primary" onClick={() => navigate('/hr/purchase-requests/create')}>
                <Plus size={16} /> New PR
              </button>
            )}
          </div>
                  ...
                  <td>
                    <div className="hr-actions">
                      ...
                      {can('procurement.requisitions.edit') && (r.status === 'draft' || r.status === 'revision' || r.status === 'rejected') && (
                        <button className="hr-action-btn" onClick={() => navigate(`/hr/purchase-requests/${r.id}/edit`)} title="Edit"><Pencil size={15} /></button>
                      )}
